...
const RouteFilter = ({ isOpen, onClose, onApplyFilters }) => {
  ...
  useOutsideClick(originCountryRef, () => toggleDropdown("showOriginCountry", false));
  useOutsideClick(originProvinceRef, () => toggleDropdown("showOriginProvince", false));
  useOutsideClick(originCityRef, () => toggleDropdown("showOriginCity", false));
  useOutsideClick(originStationRef, () => toggleDropdown("showOriginStation", false));
  useOutsideClick(destinationCountryRef, () => toggleDropdown("showDestinationCountry", false));
  useOutsideClick(destinationProvinceRef, () => toggleDropdown("showDestinationProvince", false));
  useOutsideClick(destinationCityRef, () => toggleDropdown("showDestinationCity", false));
  ...
  useEffect(() => {
    if (filters.originCountryId) {
      dispatch(fetchProvinces({ 
        countryId: filters.originCountryId, 
  ...
  useEffect(() => {
    if (filters.destinationCountryId) {
      dispatch(fetchProvinces({ 
        countryId: filters.destinationCountryId, 
  ...
  useEffect(() => {
    if (filters.destinationCityId) {
      dispatch(fetchStations({ 
        cityId: filters.destinationCityId, 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-end">
      ...
      <div className="relative z-50 bg-white rounded-r-lg shadow-xl w-96 h-full overflow-y-auto">
        <div className="flex items-center justify-between p-4 border-b">
          <h3 className="text-lg font-semibold">{t("FILTER_ROUTES")}</h3>
          <button onClick={onClose} className="text-gray-500 hover:text-gray-700">
            <CloseIcon className="w-6 h-6" />
          </button>
        </div>
        ...
        <div className="p-4">
          ...
          <div className="mb-6">
            ...
            {/* Origin Country */}
            <div className="mb-3" ref={originCountryRef}>
              <label className="block text-sm font-medium text-gray-700 mb-1">{t("COUNTRY")}</label>
              <div className="relative">
                <input
                  type="text"
            ...
            {/* Origin Province */}
            {filters.originCountryId && (
              <div className="mb-3" ref={originProvinceRef}>
                <label className="block text-sm font-medium text-gray-700 mb-1">{t("PROVINCE")}</label>
                <div className="relative">
                  <input
                    type="text"
            ...
            {/* Origin City */}
            {filters.originProvinceId && (
              <div className="mb-3" ref={originCityRef}>
                <label className="block text-sm font-medium text-gray-700 mb-1">{t("CITY")}</label>
                <div className="relative">
                  <input
                    type="text"
          ...
          <div className="mb-6">
            ...
            {/* Destination Country */}
            <div className="mb-3" ref={destinationCountryRef}>
              <label className="block text-sm font-medium text-gray-700 mb-1">{t("COUNTRY")}</label>
              <div className="relative">
                <input
                  type="text"
            ...
            {/* Destination Province */}
            {filters.destinationCountryId && (
              <div className="mb-3" ref={destinationProvinceRef}>
                <label className="block text-sm font-medium text-gray-700 mb-1">{t("PROVINCE")}</label>
                <div className="relative">
                  <input
                    type="text"
            ...
            {/* Destination City */}
            {filters.destinationProvinceId && (
              <div className="mb-3" ref={destinationCityRef}>
                <label className="block text-sm font-medium text-gray-700 mb-1">{t("CITY")}</label>
                <div className="relative">
                  <input
                    type="text"
