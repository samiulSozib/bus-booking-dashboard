  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!formData.berth_type || !formData.rows || !formData.columns) {
        setErrors({
          ...errors,
          berth_type: !formData.berth_type
            ? t("bus.berthTypeRequired")
            : undefined,
          rows: !formData.rows ? t("bus.rowsRequired") : undefined,
          columns: !formData.columns ? t("bus.columnsRequired") : undefined,
        });
      ...
      if (
        ...
        Swal.fire({
          ...
          title: t("bus.successTitle"),
          text: busId
            ? t("bus.updatedSuccessfully")
            : t("bus.addedSuccessfully"),
          confirmButtonText: t("common.ok"),
          timer: 2000,
          timerProgressBar: true,
          willClose: () => {
        ...
        <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg p-6 w-full max-w-md max-h-[80vh] flex flex-col dark:bg-gray-800 overflow-y-auto">
            <h3 className="text-lg font-semibold mb-4 dark:text-white/90">
              {formData.berth_type === "lower"
                ? t("CONFIGURE_LOWER_BERTH")
                : t("CONFIGURE_UPPER_BERTH")}
            </h3>
            ...
            <div className="grid grid-cols-2 gap-4 max-h-[60vh] overflow-y-auto">
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  value={`${String.fromCharCode(64 + selectedSeat.row)}${
                    selectedSeat.column
                  }`}
                  ...
                  <label className="inline-flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        setSelectedSeat({
                          ...selectedSeat,
                          is_recliner: parseInt(e.target.value),
                        })
                      }
                  ...
                  <label className="inline-flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        setSelectedSeat({
                          ...selectedSeat,
                          is_sleeper: parseInt(e.target.value),
                        })
                      }
                      className="form-radio h-4 w-4 text-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600"
                    />
