        ...
        <div className="fixed inset-0 z-50 flex items-end justify-end">
            ...
            <div className="relative z-50 bg-white rounded-r-lg shadow-xl w-96 h-full overflow-y-auto">
                ...
                <div className="p-4">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="relative">
                            <input
                                ...
                                onBlur={() => setTimeout(() => toggleDropdown("showVendor", false), 200)}
                    ...
                    <div className="mb-4">
                        ...
                        <div className="relative">
                            <input
                                ...
                                onBlur={() => setTimeout(() => toggleDropdown("showRoute", false), 200)}
                                className="w-full p-2 border rounded"
                            />
                            {dropdowns.showRoute && (
                                <div className="absolute z-10 mt-1 w-full bg-white border rounded shadow-lg max-h-60 overflow-y-auto">
                                    {routes
                                        .filter((route) =>
                                            route.name.toLowerCase().includes(searchTags.route.toLowerCase())
                                        )
                                        .map((route) => (
                                            <div
                                                key={route.id}
                    ...
                    {/* Bus Filter */}
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-gray-700 mb-1">{t("BUS")}</label>
                        <div className="relative">
                            <input
                                type="text"
                                ...
                                onBlur={() => setTimeout(() => toggleDropdown("showBus", false), 200)}
                                className="w-full p-2 border rounded"
                            />
                            {dropdowns.showBus && (
                                <div className="absolute z-10 mt-1 w-full bg-white border rounded shadow-lg max-h-60 overflow-y-auto">
                                    {buses
                                        .filter((bus) =>
                                            (bus.plateNumber || bus.id.toString()).toLowerCase().includes(searchTags.bus.toLowerCase())
                                        )
                                        .map((bus) => (
                                            <div
                                                key={bus.id}
                    ...
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-gray-700 mb-1">{t("DEPARTURE_TIME")}</label>
                        <input
                            type="datetime-local"
