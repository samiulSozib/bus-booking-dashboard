...
//     customer_mobile: Yup.string().required(t("booking.mobileRequired")),
//     customer_first_name: Yup.string().required(t("booking.firstNameRequired")),
//     customer_last_name: Yup.string().required(t("booking.lastNameRequired")),
//     tickets: Yup.array()
...
//   return (
//     <div className="container mx-auto px-2 sm:px-4 py-4 text-sm bg-gray-50 min-h-screen">
//       <div className="flex justify-between items-center mb-4">
//         <h1 className="text-xl md:text-2xl font-bold text-gray-800 flex items-center">
//           <FaChair className="mr-2 md:mr-3 text-blue-600" />
...
//       <div className="bg-gradient-to-r from-blue-50 to-indigo-50 shadow rounded-xl p-4 md:p-5 mb-4 md:mb-6 border border-blue-100">
//         <div className="flex flex-col md:flex-row md:items-center justify-between mb-3">
//           <h2 className="text-base font-semibold text-gray-800 flex items-center mb-2 md:mb-0">
//             <FaInfoCircle className="mr-2 text-blue-600" />
//             {t("booking.bookingMode")}
//           </h2>
...
//           </div>
//         </div>
//         <p className="text-xs md:text-sm text-gray-600 mb-2 md:pl-7">
//           {quickBookingMode
//             ? t("booking.quickModeDescription")
//             : t("booking.detailedModeDescription")}
//         </p>
//       </div>
