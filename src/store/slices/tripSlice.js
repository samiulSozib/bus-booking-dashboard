...
export const showTrip = createAsyncThunk(
  ...
  async ({ trip_id }, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.get(
        `${base_url}/${type.role}/trips/${trip_id}/show`,
        {
          headers: {
            Authorization: `${token}`,
            "Content-Type": "application/json",
...
export const addTrip = createAsyncThunk(
  ...
  async (tripData, { rejectWithValue }) => {
    try {
      ...
      formData.append(
        "min_partial_payment",
        parseFloat(tripData.min_partial_payment)
      );
  ...
  async ({ tripId, updatedData }, { rejectWithValue }) => {
    try {
      ...
      formData.append(
        ...
        updatedData.allow_partial_payment
      );
      ...
      //console.log(updatedData)
      const response = await axios.post(
        `${base_url}/${type.role}/trips/update`,
        formData,
        {
          headers: {
            Authorization: `${token}`,
  ...
  async (tripId, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.delete(
        `${base_url}/${type.role}/trips/${tripId}/delete`,
        {
          headers: {
            Authorization: `${token}`,
          },
...
export const updateTripSeatPrices = createAsyncThunk(
  ...
  async ({ trip_id, ticket_price_per_seat }, { rejectWithValue }) => {
    try {
      ...
      formData.append(
        "ticket_price_per_seat",
        JSON.stringify(ticket_price_per_seat)
      );
